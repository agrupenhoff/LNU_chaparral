...
str(propnativeRich_small)
propnativeRich_small$Site <- as.factor(propnativeRich_small$Site)
propnativeRich_small$ppt <- as.numeric(propnativeRich_small$ppt)
#run random forest model

ctree <- ctree(prop_native_rich ~ num_burn ,
                data = propnativeRich_small)
plot(ctree)

ctree1 <- ctree(prop_native_rich ~ num_burn + TSLF +
                  hli + cool_warm_slope + ppt ,
                    data = propnativeRich_small,
...
hist(log(shrub_density_OBLS$presence))
